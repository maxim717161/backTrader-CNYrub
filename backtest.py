...
В работе четыре окна по общему итогу. Короткие 530 и 520 минут закрываются
каналом той же длины, без защитного стопа. Длинные 12 240 и 12 600 минут
держат стоп в 22 медианы минутного диапазона и не выходят по каналу.
"""
...
REFINE_STEP = 120
REFINE_RADIUS = 480
# Четыре окна по общему итогу при уже выбранных выходах.
# Короткое, сетка 480–1440 шаг 10: выход той же длины, стопа нет.
# Длинное, сетка 11520–13440 шаг 120: выход по каналу выключен, стоп 22.
SHORT_WINDOW = 530
LONG_WINDOW = 12_240
LONG_STOP = 22.0
